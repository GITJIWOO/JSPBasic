...
<body>
	...
	<form action="user_update_ok.jsp" method="post">
		<input type="text" name="chanId" value="<%= resultSet.getUid() %>" placeholder="아이디" readonly required><br/>
		<input type="password" name="chanPw" placeholder="비밀번호" required><br/>
		<input type="text" name="chanName" value="<%= resultSet.getUname() %>" placeholder="이름" required><br/>
